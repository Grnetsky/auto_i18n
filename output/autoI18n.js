...
var hasRequiredAutoI18n;
function requireAutoI18n() {
  if (hasRequiredAutoI18n) return autoI18n$1;
  hasRequiredAutoI18n = 1;
  const {
    select,
    input,
    Separator,
  ...
  program.command('cli').description("Let's do this").option('-c, --config <path>', '配置文件').action(async () => {
...
var autoI18nExports = requireAutoI18n();
var autoI18n = /*@__PURE__*/getDefaultExportFromCjs(autoI18nExports);
